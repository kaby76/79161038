...
{
    public static SharpMUSHParser Parser { get; set; }
    public static ErrorListener<IToken> ParserErrorListener { get; set; }
    public static SharpMUSHLexer Lexer { get; set; }
    ...
    public static string StartSymbol { get; set; } = "startPlainString";
    ...
    public static void SetupParse2(string input, bool quiet = false)
    {
        ...
        CharStream = str;
        var lexer = new SharpMUSHLexer(str);
        Lexer = lexer;
    ...
    {
        var tree = Parser.startPlainString();
        ...
        foreach (var decision in decisions)
        {
            ...
            foreach (AmbiguityInfo ai in am)
            {
                ...
                var p = Parser.RuleNames.Select((value, index) => new { value, index })
                        .Where(pair => (pair.value == "startPlainString"))
